...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar CORS = exports.CORS = 'https://cors-anywhere.herokuapp.com/';\nvar unsplashAccessKey = exports.unsplashAccessKey = '01c2d7a12a096f55446e341f93ab73df5115a5f55caa18ec93d2018645d8c338';\n\n//# sourceURL=webpack:///./src/js/config.js?");
...
"use strict";
eval("\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ./config */ \"./src/js/config.js\");\n\nvar _Artist = __webpack_require__(/*! ./models/Artist */ \"./src/js/models/Artist.js\");\n\nvar _Image = __webpack_require__(/*! ./models/Image */ \"./src/js/models/Image.js\");\n\nvar _Album = __webpack_require__(/*! ./models/Album */ \"./src/js/models/Album.js\");\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n_base.elements.generate.addEventListener('click', function (e) {\n    // Clear results if any\n    (0, _Image.clearImage)();\n    (0, _Album.clearQuote)();\n    (0, _Artist.clearPage)();\n    (0, _Image.clearPhotographerInfo)();\n\n    // Fetch and render results\n    (0, _Image.getRandomImage)();\n    (0, _Artist.getRandomPage)();\n    (0, _Album.getRandomQuote)();\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearQuote = exports.getRandomQuote = undefined;\n\n// Get random quote from Tadas Talaikis' API to serve as album name based on tbe last 3-5 words\nvar getRandomQuote = exports.getRandomQuote = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var result, quote, q, i, name;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n                        _context.prev = 0;\n                        _context.next = 3;\n                        return (0, _axios2.default)('https://talaikis.com/api/quotes/random/');\n\n                    case 3:\n                        result = _context.sent;\n                        quote = result.data.quote;\n                        q = JSON.stringify(quote).split(' ');\n                        i = Math.floor(Math.random() * 3 + 3); //Better way to select the last 3-5 words; (max-min + 1) + min -> 5 - 3 + 1 = 3;\n\n                        name = q.slice(q.length - i, q.length).join(' ');\n\n                        name = name.replace(\".\\\"\", '');\n                        name = name.charAt(0).toUpperCase() + name.slice(1);\n\n                        _base.elements.album.insertAdjacentHTML('afterbegin', name);\n                        _context.next = 16;\n                        break;\n\n                    case 13:\n                        _context.prev = 13;\n                        _context.t0 = _context['catch'](0);\n\n                        console.log(_context.t0);\n\n                    case 16:\n                    case 'end':\n                        return _context.stop();\n                }\n            }\n        }, _callee, this, [[0, 13]]);\n    }));\n\n    return function getRandomQuote() {\n        return _ref.apply(this, arguments);\n    };\n}();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar clearQuote = exports.clearQuote = function clearQuote() {\n    _base.elements.album.innerHTML = '';\n};\n\n//# sourceURL=webpack:///./src/js/models/Album.js?");

/***/ }),

/***/ "./src/js/models/Artist.js":
/*!*********************************!*\
  !*** ./src/js/models/Artist.js ***!
  \*********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearPage = exports.getRandomPage = undefined;\n\n// Get random page from Wikipedia API to serve as artist title\nvar getRandomPage = exports.getRandomPage = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var result, title;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n                        _context.prev = 0;\n                        _context.next = 3;\n                        return (0, _axios2.default)(_config.CORS + 'https://en.wikipedia.org/w/api.php?action=query&list=random&rnnamespace=0&rnlimit=1&format=json');\n\n                    case 3:\n                        result = _context.sent;\n                        title = result.data.query.random[0].title;\n\n\n                        _base.elements.artist.insertAdjacentHTML('afterbegin', title);\n                        _context.next = 11;\n                        break;\n\n                    case 8:\n                        _context.prev = 8;\n                        _context.t0 = _context['catch'](0);\n\n                        console.log(_context.t0);\n\n                    case 11:\n                    case 'end':\n                        return _context.stop();\n                }\n            }\n        }, _callee, this, [[0, 8]]);\n    }));\n\n    return function getRandomPage() {\n        return _ref.apply(this, arguments);\n    };\n}();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar clearPage = exports.clearPage = function clearPage() {\n    _base.elements.artist.innerHTML = '';\n};\n\n//# sourceURL=webpack:///./src/js/models/Artist.js?");

/***/ }),

/***/ "./src/js/models/Image.js":
/*!********************************!*\
  !*** ./src/js/models/Image.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearPhotographerInfo = exports.clearImage = exports.getRandomImage = undefined;\n\n// Get random image from Unsplash API to serve as album image\nvar getRandomImage = exports.getRandomImage = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var result, image, photographerName, photographerUserName;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n                        _context.prev = 0;\n                        _context.next = 3;\n                        return (0, _axios2.default)(_config.CORS + 'https://api.unsplash.com/photos/random/?client_id=' + _config.unsplashAccessKey);\n\n                    case 3:\n                        result = _context.sent;\n                        image = result.data.urls.small;\n                        photographerName = result.data.user.name;\n                        photographerUserName = result.data.user.username;\n\n                        //Sets image src to JSON's small image result\n\n                        _base.elements.image.src = image;\n\n                        // Inserts link to attribute photographer and Unsplash\n                        _base.elements.photographer.insertAdjacentHTML('afterbegin', 'Photo by <a href=\"https://unsplash.com/@' + photographerUserName + '?utm_source=album_creator&utm_medium=referral\">' + photographerName + '</a> on <a href=\"https://unsplash.com/?utm_source=album_creator&utm_medium=referral\">Unsplash</a>');\n                        _context.next = 14;\n                        break;\n\n                    case 11:\n                        _context.prev = 11;\n                        _context.t0 = _context['catch'](0);\n\n                        console.log(_context.t0);\n\n                    case 14:\n                    case 'end':\n                        return _context.stop();\n                }\n            }\n        }, _callee, this, [[0, 11]]);\n    }));\n\n    return function getRandomImage() {\n        return _ref.apply(this, arguments);\n    };\n}();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar clearImage = exports.clearImage = function clearImage() {\n    _base.elements.image.src = '';\n};\n\nvar clearPhotographerInfo = exports.clearPhotographerInfo = function clearPhotographerInfo() {\n    _base.elements.photographer.innerHTML = '';\n};\n\n//# sourceURL=webpack:///./src/js/models/Image.js?");
